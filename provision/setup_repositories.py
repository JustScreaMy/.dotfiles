...
def setup_repos():
    ...
    repo_url = [
        { "name": "trivy", "baseurl": "https://aquasecurity.github.io/trivy-repo/rpm/releases/$basearch/", "gpgkey": "https://aquasecurity.github.io/trivy-repo/rpm/public.key" },
        { "name": "vscode", "baseurl": "https://packages.microsoft.com/yumrepos/vscode", "gpgkey": "https://packages.microsoft.com/keys/microsoft.asc" }
    ]
